...
const VerticalSlides = dynamic(
  () =>
    import('components/vertical-slides').then((mod) => mod.VerticalSlides),
  { ssr: false }
)
...
export default function Home() {
  ...
  return (
    <Layout
      theme={theme}
      seo={{
        title: 'BooFi – Spooky Finance Made Easy',
        description:
          'BooFi is a friendly ghost gu',
      }}
      className={s.home}
    >
