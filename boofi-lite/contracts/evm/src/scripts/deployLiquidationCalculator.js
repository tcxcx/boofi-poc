...
async function main() {
    ...
    console.log("Deploying LiquidationCalculator with the account:", deployer.address);
    ...
    const LiquidationCalculator = await ethers.getContractFactory("LiquidationCalculator");
    ...
    console.log("LiquidationCalculator deployed to:", liquidationCalculator.address);
}
