...
contract LiquidatorFlashLoan is IFlashLoanReceiver, Liquidator {
    ...
    using SwapAmountsOracle for IBooFiPriceOracle;
    ...
    IBooFiPriceOracle public immutable PRICE_ORACLE;
    ...
    constructor(
        ...
        IBooFiPriceOracle _boofiPriceOracle,
        IERC20 _profitToken,
        ...
        require(address(_boofiPriceOracle) != address(0), "LiquidatorFlashLoan: boofi price oracle address is zero");

        POOL = _pool;
        ADDRESSES_PROVIDER = IPoolAddressesProvider(_pool.ADDRESSES_PROVIDER());
        UNISWAP_ROUTER = _uniswapRouter;
        PRICE_ORACLE = _boofiPriceOracle;
