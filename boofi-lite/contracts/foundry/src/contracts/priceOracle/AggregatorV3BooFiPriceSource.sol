...
/**
 * @title AggregatorV3BooFiPriceOracle
 */
contract AggregatorV3BooFiPriceSource is BaseBooFiPriceSource {
    ...
    constructor(string memory _outputAsset) BaseBooFiPriceSource(_outputAsset) {}
