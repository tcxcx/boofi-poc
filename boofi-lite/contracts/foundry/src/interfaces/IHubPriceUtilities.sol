...
interface IHubPriceUtilities {
    ...
    function getPriceOracle() external view returns (IBooFiPriceOracle);
    function setPriceOracle(IBooFiPriceOracle _priceOracle) external;
