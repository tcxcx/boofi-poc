...
const TabsNeo = TabsPrimitive.Root

const TabsListNeo = React.forwardRef<
...
TabsListNeo.displayName = TabsPrimitive.List.displayName

const TabsTriggerNeo = React.forwardRef<
...
TabsTriggerNeo.displayName = TabsPrimitive.Trigger.displayName

const TabsContentNeo = React.forwardRef<
...
TabsContentNeo.displayName = TabsPrimitive.Content.displayName

export { TabsNeo, TabsListNeo, TabsTriggerNeo, TabsContentNeo }