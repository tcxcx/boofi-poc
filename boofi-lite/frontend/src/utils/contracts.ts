...
export const destinationChains = [
  {
    ...
    ccipChainId: 14767482510784806043, //// ccip chain id for avalanche fuji
    name: "Avalanche Fuji",
    chainId: 43113,
  },
  {
    address: "0x0000000000000000000000000000000000000000", // this chain is only used for ccip
    ccipChainId: 16015286601757825753, //// ccip chain id for sepolia
    name: "Sepolia",
    chainId: 11155111, // chain id for sepolia
  },
  {
    address: "0x480f9F2Fe22cB70C92058f34d5E89F0D8441146d", // base sepolia
    ccipChainId: 10344971235874465080, // ccip chain id for base sepolia
